...
When navigating forward and backward between the two fragments, eventually (sometimes much earlier than later) the app will crash with a `signal 6 (SIGABRT)`. I've seen the crash happen on Google Pixels running Android 10 and Android 11. Stacktrace:
